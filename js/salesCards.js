...
/**
* Crea una tarjeta HTML basada en los datos proporcionados.
* @function
* @param {Object} data - Datos de la tarjeta.
* @param {string} data.image - Ruta de la imagen.
* @param {string} data.tag - Etiqueta de descuento.
* @param {string} data.title - Título de la tarjeta.
* @param {number} data.price - Precio de la tarjeta.
* @param {number} data.ratings - Calificación de la tarjeta.
* @param {number} data.ratingNumbers - Número de calificaciones.
* @returns {HTMLElement} - Elemento de la tarjeta HTML.
*/
...
/**
* Crea iconos de estrellas basados en la calificación.
* @function
* @param {number} ratings - Calificación para generar estrellas.
* @returns {string} - Código SVG de estrellas.
*/
...
/**
* Agrega las tarjetas al contenedor del carrusel.
* @function
* @returns {void}
*/
